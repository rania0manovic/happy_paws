...
class _ViewAppointmentDetailsState extends State<ViewAppointmentDetails> {
  ...
  Future<void> fetchSetData() async {
    ...
    var response = await EmployeesService()
                       ...
                       children: [
                         ...
                         Text(
                           DateFormat('dd/MM/yyyy HH:mm').format(
                               DateTime.parse(widget.appointment['createdAt'])),
                           style: const TextStyle(
                               fontSize: 18, fontWeight: FontWeight.w600),
                         ),
                       ],
                       ...
                       children: [
                         ...
                         Text(
                           DateFormat('dd/MM/yyyy').format(
                               DateTime.parse(widget.appointment['startDateTime'])),
                       ...
                       children: [
                         ...
                         Text(
                           "${DateFormat('HH:mm').format(
                               DateTime.parse(widget.appointment['startDateTime']))} - ${DateFormat('HH:mm').format(
                               DateTime.parse(widget.appointment['endDateTime']))}",
                           style: const TextStyle(
                               fontSize: 18, fontWeight: FontWeight.w600),
                         ),
